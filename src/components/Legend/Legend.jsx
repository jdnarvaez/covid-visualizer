    ...
    <div className="map-legend">
      <svg viewBox="-3 -3 21 156">
        <defs>
          ...
          {Object.keys(interpolators).map(layer => <InterpolatedGradient key={layer} id={gradients[layer]} interpolate={interpolators[layer]} invert={layer === 'testPositivityRatio' || layer === 'infectionRate' }/>)}
        </defs>
